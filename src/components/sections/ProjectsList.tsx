...
function ProjectCard({ project, index, progress, targetScale }: any) {
  ...
  return (
    <div ref={containerRef} className="h-[92svh] min-h-[600px] md:h-screen flex items-center justify-center sticky top-0">
      <motion.div 
        style={{ scale, top: `calc(-10% + ${index * 40}px)` }}
        className="w-full max-w-6xl h-[84svh] min-h-[560px] md:h-[80vh] md:min-h-0 bg-[#111] rounded-3xl border border-white/10 p-5 md:p-12 flex flex-col justify-between relative transform-gpu"
      >
        ...
        <div className="flex-1 min-h-0 w-full mt-5 md:mt-8 flex flex-col md:flex-row gap-4 md:gap-6 overflow-hidden">
          {/* Main Visual Area */}
          <div className="flex-1 min-h-[170px] md:min-h-0 h-full rounded-2xl bg-black/50 border border-white/5 relative overflow-hidden flex items-center justify-center group">
          ...
          <div className="w-full md:w-1/3 h-auto md:h-full flex flex-col gap-4 md:gap-6">
            <div className="h-auto min-h-[104px] md:h-1/2 rounded-2xl bg-black/50 border border-white/5 p-4 md:p-6 flex flex-col gap-2 md:gap-4">
        ...
        <div className="mt-5 md:mt-8 flex justify-between items-center">
